...
<div class="blog">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <h3 class="single_head">diam nonummy nibh</h3>
                <div class="extra">
                    <time update="" datetime="2014-03-30T14:47:59">
                        July 2, 2014 - 14:47					</time> /
                    by <span class="username"> <a href="#" class="comment_count">admin</a></span> /
                    <a href="#" class="comment_count">1 comment(s)</a>
                </div>
                <img src="images/b2.jpg" class="img-responsive" alt=""/>
                <p class="single_text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
                <p class="single_text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
                <p class="single_text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
                <ul class="links">
                    <li><i class="blog_icon1"> </i><span class="icon_text">june 14, 2013</span></li>
                    <li><a href="#"><i class="blog_icon2"> </i><span class="icon_text">admin</span></a></li>
                    <li><a href="#"><i class="blog_icon3"> </i><span class="icon_text">No comments</span></a></li>
                    <li><a href="#"><i class="blog_icon4"> </i><span class="icon_text">View posts</span></a></li>
                    <li><a href="#"><i class="blog_icon5"> </i><span class="icon_text">permalink</span></a></li>
                    <div class="clearfix"> </div>
                </ul>
                <div class="comment">
                    <h2>Comments</h2>
                    <ul class="comment-list">
                        <li><img src="images/pic11.jpg" class="img-responsive" alt=""/>
                            <div class="desc">
                                <h5><a href="#">Lorem ipsum dolor sit amet</a></h5>
                                <div class="extra">
                                    <time pubdate="" datetime="2014-03-30T14:47:59">
                                        Submitted by admin on July 02, 2014 - 14:47					</time>
                                </div>
